...
urlpatterns = [
    ...
    path('dashboard/dentist/send-suggestion/', views.send_suggestion_view, name='send_suggestion'),
    path('dashboard/dentist/request-images/', views.request_images_view, name='request_images'),
    path('dashboard/patient/requested-images/<int:request_id>/', views.upload_requested_images_view, name='upload_requested_images'),
    path('dashboard/dentist/view-requested-images/<int:request_id>/', views.view_requested_images, name='view_requested_images'),
    path('dashboard/patient/request-appointment/', views.request_appointment_view, name='request_appointment'),
    path('dashboard/dentist/offer-slots/<int:request_id>/', views.offer_appointment_slots_view, name='offer_appointment_slots'),
    path('dashboard/patient/select-slot/<int:request_id>/', views.select_appointment_slot_view, name='select_appointment_slot'),
